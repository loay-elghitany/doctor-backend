 ...
 * Middleware: protectDoctor (verifies JWT, sets req.doctor)
 ...
 * Middleware: protectDoctor, checkSubscriptionForAction (verifies subscription is active)
 * Returns: 200 with updated appointment or 409 if time slot booked
 */
router.put("/:id", protectDoctor, updateAppointmentStatus);
 ...
 */
router.patch("/:id/propose-times", protectDoctor, proposeTimes);
 ...
 */
router.delete("/:id", protectDoctor, cancelAppointment);
